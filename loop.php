		...
		<div class="post-wrapper clearfix">
			<aside>
				<?php 
					if ( has_post_thumbnail()) {
					   ...
					   echo '<img src="'.$large_image_url[0].'" class="attachment-post-thumbnail">';
					 } else {
					   echo '<img src="http://smarterremarketer.com/wp-content/uploads/2012/03/logo_blog.png" class="attachment-post-thumbnail">';
					 }
				 ?>
			</aside>
			<div class="post-content">
				...
				<?php if ( is_archive() || is_search() ) : // Only display excerpts for archives and search. ?>
						<p><?php the_excerpt(); ?></p>
				<?php else : ?>
						<span class="continue"><?php the_excerpt( __( 'Continue reading &rarr;', 'twentyten' ) ); ?></span>
