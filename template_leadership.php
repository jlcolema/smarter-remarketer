			...
			<section id="copy">
				<div class="subpage clearfix">
					<article title="<?php the_title(); ?>">
						<header>
							<h2>Smarter Remarketer Leadership</h2>
						</header>
						<aside>
							<nav>
						...
						<div class="copy" role="content">
							<?php
								...
								$args = array(
									...
									'post_status'=>'publish',
									'taxonomy' => 'team-role',
									'term' => 'board-of-managers'
								);
								echo '<h1>Board of Managers</h1>';
								echo output_team($args);
								...
								$args = array(
									...
									'post_status'=>'publish',
									'taxonomy' => 'team-role',
									'term' => 'board-of-advisors'
								);
								echo '<h1>Board of Advisors</h1>';
								echo output_team($args);
